...
define ("LANGUAGE","PHP");
	...
	//Change value of constants

define ("LANGUAGE","JAVA");
echo "This program is written using " . LANGUAGE . "<br>"; //Nece se promijeniti vrijednost, drzi onu vrijednost koja mu je vec data a to je PHP. CONSTANTA NE MOJENJA VRIJEDNOST
